...
class PrinterConfigManager:
    ...
    def get_available_printers(self) -> List[str]:
        ...
        try:
            # First, gather printers shipped with the application (firmware templates)
    ...
    def get_printer_config_from_variables(self, printer_name: str) -> Dict[str, Any]:
        ...
        config = {
            ...
            # Secondary heaters support (H0/H1 etc.)
            'hasSecondaryHeaters': bool(variables.get('has_secondary_heaters', variables.get('secondary_heaters', False))),
    ...
    def extract_printer_configuration(self, variables: Dict[str, Any]) -> Dict[str, Any]:
        ...
        config = {
            ...
            'IS_DUAL_NOZZLE': bool(variables.get('is_dual_nozzle', 0)),
            # Secondary heaters indicator for configuration generation
            'has_secondary_heaters': bool(variables.get('has_secondary_heaters', variables.get('secondary_heaters', False))),
        }
    ...
    def update_octoprint_printer_profile(self, printer_name: str) -> bool:
        ...
        try:
            ...
            # Propagate secondary heaters flag into the OctoPrint profile
            profile_data['hasSecondaryHeaters'] = bool(printer_config.get('hasSecondaryHeaters', False))
